...
var questions = [
    ...
    },
    {
        ...
        answer: "<b>От 186 до 193 суток</b>. Полярным днем называется период, когда Солнце не заходит за горизонт дольше одних суток. На Северном полюсе полярный день продолжается около 186 суток и 10 часов, приблизительно с 18 марта по 26 сентября, но фактически, вследствие рефракции света, день продолжается около 193 суток.",
        versions: [
            "От 186 до 193 суток",
            "От 142 до 153 суток",
            "От 34 до 56 суток",
    ...
    },
    {
        ...
        answer: "<b>Приразломная</b>. Морская ледостойкая стационарная платформа (МЛСП) «Приразломная» является первой и пока единственной платформой, ведущей добычу нефти на российском арктическом шельфе.",
        subanswer: [
    ...
    },
    {
        ...
        answer: "<b>«Газпром нефть»</b>. Первой компанией, начавшей добычу нефти на шельфе Арктики, стала компания «Газпром нефть». Добыча ведется с морской ледостойкой стационарной платформы «Приразломная». Первая нефть была добыта с платформы в декабре 2013 года. Доставка нефти потребителям Северо-Западной Европы ведется с помощью новых российских танкеров усиленного ледового класса. Всего в 2014 году c платформы «Приразломная» было отгружено 300 тыс. тонн нефти.",
        versions: [
            "«Газпром нефть»",
            "«Лукойл»",
            "«Роснефть»",
    ...
    },
    {
        ...
        answer: "<b>1,8 метра</b>. В последние годы толщина арктического морского льда значительно уменьшилась. Исследовательский центр «Catlin Arctic Survey» сообщает, что средняя толщина льда составляет 1,8 м в северной части моря Бофорта - области, которая традиционно содержит более старый и толстый лёд.",
        versions: [
    ...
    },
    {
        ...
        answer: "<b>Россия</b>. Первый в мире ледокол «Ермак» был построен в Ньюкасле на стапелях британской фирмы Armstrong Whitworth в 1897-1898 гг. по заказу России. Это было первое в мире судно подобного класса, способное форсировать тяжелые льды двухметровой толщины. Руководил строительством адмирал Макаров.",
        versions: [
            "Россия",
            "Великобритания",
            "Дания",
    ...
    },
    {
        ...
        answer: "<b>России</b>. Титановый флаг России был установлен на океаническом дне Северного полюса на глубине 4 261 метр двумя глубоководными аппаратами «Мир».",
        versions: [
            "России",
            "США",
            "Японии",
...
var results = [
    'Ваши знания об Арктике оставляют желать лучшего, но это поправимо. Следите за обновлениями проекта (следует название) - и вскоре вы сможете открыть для себя много нового!',
    'Вы неплохо разбираетесь в предмете, но тема Арктики поистине неисчерпаема. Следите за обновлениями проекта (следует название) - и вскоре вы сможете открыть для себя много нового!',
    'Судя по всему, вы весьма начитаны и хорошо знакомы с темой. И хотя в настоящую арктическую экспедицию ехать вам пока рановато, вас вполне можно считать полярником-любителем. Следите за обновлениями проекта (следует название) и продолжайте расширять свои познания!',
    'Поздравляем! Вы показали отличные знания об Арктике и можете считаться настоящим полярником. Следите за обновлениями проекта (следует название) и продолжайте расширять свои познания!',
    'Великолепно! Ваши знания об Арктике настолько обширны и глубоки, что Вас можно назвать опытным арктическим исследователем. Следите за обновлениями проекта (следует название)!'
];
